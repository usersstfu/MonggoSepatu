...
if(isset($_POST['submit']))
 ...
 insertDetail($id_detail,$id_sepatu,$jumlah_beli);
...
<head>
    ...
    <title>Halaman Admin - Tambah Detail</title>
</head>
                    ...
                    <div class="card col-lg-12 p-3">
                        ...
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan Judul" name="id_detail">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan Judul" name="jumlah_beli">
                            </div>
