...
if(isset($_POST['submit']))
 ...
 $bayar = $_POST['bayar'];
 insertHeader($tanggal,$id_detail, $bayar);
...
<head>
    ...
    <title>Halaman Admin - Tambah Header</title>
</head>
                    ...
                    <div class="card col-lg-12 p-3">
                        ...
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" placeholder="Masukan Judul" name="tanggal">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan Judul" name="bayar">
                            </div>
                            </div>
