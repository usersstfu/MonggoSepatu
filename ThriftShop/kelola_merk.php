...
<head>
    ...
    <title>Halaman Admin - Kelola Merk</title>
</head>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="card col-lg-12 p-3">
                        ...
                        <hr>
                        <div>
                            <a href="tambah_merk.php" class="btn btn-primary">Tambah Merk</a>
                        </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($merk as $row) : ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td>
                                            <a href="ubah_merk.php?id=<?php echo $row["id_merk"]; ?>" class="btn btn-primary btn-sm">Ubah</a>
                                            <a href="hapus_merk.php?id=<?php echo $row["id_merk"]; ?> " onclick="return confirm('Yakin Ingin Menghapus Data?');" class="btn btn-danger btn-sm">Hapus</a>
                                        </td>
