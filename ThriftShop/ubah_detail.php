...
$roww = query("SELECT * FROM detail_bayar WHERE id_detail = $id")[0];
...
updateDetail($id_detail,$id_sepatu, $jumlah_beli);
...
<head>
    ...
    <title>Halaman Admin - Ubah Detail</title>
</head>
                    ...
                    <div class="card col-lg-12 p-3">
                        ...
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="id_detail" value="<?php echo $roww["id_detail"]; ?>">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="jumlah_beli" value="<?php echo $roww["jumlah_beli"]; ?>">
                            </div>

                            <button type="submit" class="btn btn-primary" name="submit">Simpan</button>
                            <a href="kelola_detail.php" class="btn btn-primary">Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
