...
if(isset($_POST['submit']))
 ...
 insertMerk($id_merk,$nama_merk,$model_sepatu);
...
<head>
    ...
    <title>Halaman Admin - Tambah Merk</title>
</head>
                    ...
                    <div class="card col-lg-12 p-3">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan Judul" name="nama_merk">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Model Sepatu</label>
                                <input type="text" class="form-control" placeholder="Masukan Judul" name="model_sepatu">
                            </div>
