            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="card col-lg-12 p-3">
                        ...
                        <hr>
                        <div>
                            <a href="tambah_header.php" class="btn btn-primary">Tambah Header</a>
                        </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($header as $row) : ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td>
                                            <a href="ubah_header.php?id=<?php echo $row["no_nota"]; ?>" class="btn btn-primary btn-sm">Ubah</a>
                                            <a href="hapus_header.php?id=<?php echo $row["no_nota"]; ?> " onclick="return confirm('Yakin Ingin Menghapus Data?');" class="btn btn-danger btn-sm">Hapus</a>
                                        </td>
                                        <td><?php echo $row["no_nota"]; ?></td>
                                        <td ><?php echo $row["tanggal"]; ?></td>
                                        <td><?php echo $row["id_detail"]; ?></td>
                                        <td>Rp. <?php echo $row["total_Pembelian"]; ?></td>
                                        <td>Rp. <?php echo $row["bayar"]; ?></td>
                                        <td>Rp. <?php echo $row["sisa_bayar"]; ?></td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
                            </tbody>
